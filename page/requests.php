...
<!-- GRID CODE //-->
			...
			$("#jqGrid").jqGrid( {
				...
				colModel :[
					...
					{label:'IDКлиента', name:'client_id', width:50, editable:true, search:false, hidden:true, editrules:{edithidden:true}},
					{label:'IDУслуги', name:'service_id', width:50, editable:true, search:false, hidden:true, editrules:{edithidden:true}},
