...
q,r=a("<input type='button' value='+' title='Добавить правило' class='add-rule ui-add "+j.button+"'/>");r.bind("click",function(){for(void
...
E=a("<input type='button' value='-' title='Удалить правило' class='delete-rule ui-del "+j.button+"'/>");D.append(E),E.bind("click",function(){for(d=0;d<c.rules.length;d++)if(c.rules[d]===b){c.rules.splice(d,1);break}return n.reDraw(),n.onchange(),!1})}return p},this.getStringForGroup=function(a){var
b,c="(";if(void
